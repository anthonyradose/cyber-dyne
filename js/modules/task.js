...
export const tasks = {
  ...
  // Utility functions
  export const removeTaskFromList = (item, list) => list.filter((el) => el.id !== item.id);
  
  // Function to render tasks
  export const createTaskElement = (item, isCompleted) => {
  ...
  export const handleTaskSubmit = (taskInput, prioritySelect) => {
